...
public class BookRepository {
    ...
    private void loadDummyData() {
        bookList.add(new Book("Laskar Pelangi", "Andrea Hirata", 2005,
                "Kisah sepuluh anak Belitung yang berjuang menggapai mimpi di tengah keterbatasan. Novel ini menjadi fenomena sastra Indonesia yang menginspirasi juga pembaca di seluruh dunia.",
        ...
        bookList.add(new Book("Negeri 5 Menara", "Ahmad Fuadi", 2009,
                ...
                "Inspirational", 4.7f, R.drawable.negeri_5_negara));
